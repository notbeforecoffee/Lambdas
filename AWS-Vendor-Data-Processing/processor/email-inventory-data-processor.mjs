...
class EmailInventoryDataProcessor extends DataProcessor {
  async process(inventoryData) {
    console.log("email inventory data processors process method");
    ...
    await sendProcessingStatsToSlack(vendorName, "Email Inventory Data Processor", bulkRecords.length, errors);
  }
}

export default EmailInventoryDataProcessor;
